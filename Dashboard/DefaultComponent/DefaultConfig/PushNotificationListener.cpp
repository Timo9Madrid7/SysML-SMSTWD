...
//#[ ignore
PushNotificationListener::p_PushNotificationListener_severity_C::p_PushNotificationListener_severity_C(void) : unsignedint_alarmSeverity_ProxyFlowPropertyInterface(), _p_(0), itsUnsignedint_alarmSeverity_ProxyFlowPropertyInterface(NULL) {
}

PushNotificationListener::p_PushNotificationListener_severity_C::~p_PushNotificationListener_severity_C(void) {
    cleanUpRelations();
}

unsignedint_alarmSeverity_ProxyFlowPropertyInterface* PushNotificationListener::p_PushNotificationListener_severity_C::getItsUnsignedint_alarmSeverity_ProxyFlowPropertyInterface(void) {
    return this;
}

unsignedint_alarmSeverity_ProxyFlowPropertyInterface* PushNotificationListener::p_PushNotificationListener_severity_C::getOutBound(void) {
    return this;
}

void PushNotificationListener::p_PushNotificationListener_severity_C::setAlarmSeverity(unsigned int p_alarmSeverity) {
...
void PushNotificationListener::p_PushNotificationListener_severity_C::setItsUnsignedint_alarmSeverity_ProxyFlowPropertyInterface(unsignedint_alarmSeverity_ProxyFlowPropertyInterface* const p_unsignedint_alarmSeverity_ProxyFlowPropertyInterface) {
    itsUnsignedint_alarmSeverity_ProxyFlowPropertyInterface = p_unsignedint_alarmSeverity_ProxyFlowPropertyInterface;
}

void PushNotificationListener::p_PushNotificationListener_severity_C::cleanUpRelations(void) {
    if(itsUnsignedint_alarmSeverity_ProxyFlowPropertyInterface != NULL)
        {
...
PushNotificationListener::p_PushNotificationListener_state_C::p_PushNotificationListener_state_C(void) : bool_state_ProxyFlowPropertyInterface(), _p_(0), itsBool_state_ProxyFlowPropertyInterface(NULL) {
}

PushNotificationListener::p_PushNotificationListener_state_C::~p_PushNotificationListener_state_C(void) {
    cleanUpRelations();
}

bool_state_ProxyFlowPropertyInterface* PushNotificationListener::p_PushNotificationListener_state_C::getItsBool_state_ProxyFlowPropertyInterface(void) {
    return this;
}

bool_state_ProxyFlowPropertyInterface* PushNotificationListener::p_PushNotificationListener_state_C::getOutBound(void) {
    return this;
}

void PushNotificationListener::p_PushNotificationListener_state_C::setState(bool p_state) {
...
void PushNotificationListener::p_PushNotificationListener_state_C::setItsBool_state_ProxyFlowPropertyInterface(bool_state_ProxyFlowPropertyInterface* const p_bool_state_ProxyFlowPropertyInterface) {
    itsBool_state_ProxyFlowPropertyInterface = p_bool_state_ProxyFlowPropertyInterface;
}

void PushNotificationListener::p_PushNotificationListener_state_C::cleanUpRelations(void) {
    if(itsBool_state_ProxyFlowPropertyInterface != NULL)
        {
...
//#[ ignore
void PushNotificationListener::setAlarmSeverity(unsigned int p_alarmSeverity) {
    if (alarmSeverity != p_alarmSeverity)  {
        alarmSeverity = p_alarmSeverity;
        FLOW_DATA_SEND(alarmSeverity, p_PushNotificationListener_severity, setAlarmSeverity, x2String);
    }
}

void PushNotificationListener::setState(bool p_state) {
    if (state != p_state)  {
        state = p_state;
        FLOW_DATA_SEND(state, p_PushNotificationListener_state, setState, x2String);
    }
}
//#]

PushNotificationListener::p_PushNotificationListener_severity_C* PushNotificationListener::getP_PushNotificationListener_severity(void) const {
    return (PushNotificationListener::p_PushNotificationListener_severity_C*) &p_PushNotificationListener_severity;
}

PushNotificationListener::p_PushNotificationListener_severity_C* PushNotificationListener::get_p_PushNotificationListener_severity(void) const {
    return (PushNotificationListener::p_PushNotificationListener_severity_C*) &p_PushNotificationListener_severity;
}

PushNotificationListener::p_PushNotificationListener_state_C* PushNotificationListener::getP_PushNotificationListener_state(void) const {
    return (PushNotificationListener::p_PushNotificationListener_state_C*) &p_PushNotificationListener_state;
}

PushNotificationListener::p_PushNotificationListener_state_C* PushNotificationListener::get_p_PushNotificationListener_state(void) const {
    return (PushNotificationListener::p_PushNotificationListener_state_C*) &p_PushNotificationListener_state;
}

const unsigned int PushNotificationListener::getAlarmSeverity(void) const {
    return alarmSeverity;
}

const bool PushNotificationListener::getState(void) const {
    return state;
}
